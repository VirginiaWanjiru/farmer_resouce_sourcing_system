...
<body>
 ...
 <div>
   ...
   </a><button type="submit" class="btn btn-primary" style="background-color: green" onclick="window.location.href='regards.php';">Submit </button><br><br>
